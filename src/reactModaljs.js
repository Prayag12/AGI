import ja from './imagesTools/javascript.png'
import React, { Component } from 'react';
import { Modal, Button, ButtonToolbar } from 'react-bootstrap';


class MyVerticallyCenteredModalf extends Component {
...
function ModalMaker() {
  ...
  return (
    <ButtonToolbar>
      <a onClick={() => setModalShow(true)} variant="primary"><img className='icon' src={ja}/></a>
