...
import MyVerticallyCenteredModal from './reactModal';
import MyVerticallyCenteredModala from './reactModalapple'
import MyVerticallyCenteredModale from './reactModalmySQL'
import MyVerticallyCenteredModalf from './reactModaljs'
import MyVerticallyCenteredModalg from './reactModalmon'
import MyVerticallyCenteredModalm from './reactModalPr'
import MyVerticallyCenteredModalp from './reactModalFi'
import MyVerticallyCenteredModalk from './reactModalAi'
import MyVerticallyCenteredModalj from './reactModalAe'
import MyVerticallyCenteredModali from './reactModalre'
import MyVerticallyCenteredModalc from './rectModalcss'
import MyVerticallyCenteredModaln from './reactModalXd'
import MyVerticallyCenteredModald from './reactModalhtml'
import MyVerticallyCenteredModalo from './reactModalIn'
import MyVerticallyCenteredModalh from './reactModalNod'
import MyVerticallyCenteredModall from './reactModalPs'
import './services.css'
...
import GD from './imagesService/illustration.png'
...
class toolsused extends Component {
    render() {
        return (
            <div style={{ maxWidth: ''}}>
                < div className='tools'>
                    <body className='section2' style={{overflow:'hidden', maxWidth:'1475px'}}>
                        <h1 className='text' style={{textAlign: 'center', paddingTop:'50px', fontFamily:'Palatino Linotype' }}>Services</h1>
                        <div className='row'>
                        ...
                        <div className='row'>
                            ...
                            <div className="media" >
                                <img src={GD} className="align-self-start mr-3" style={{ width: '60px', paddingLeft: '15px', paddingTop: '15px' }} />
                                <div className="media-body">
                ...
                < div className='toolsused' style={{overflow:'hidden'}}>
                    <body className='section'>
                        <h1 className='text' style={{ textAlign: 'center', paddingTop:'50px', fontFamily:'Palatino Linotype'  }}>Tools & Technologies</h1>
                        <div className='panel'>
                            <div className='row'>
                            ...
                            <div className='row'>
                                ...
                                <MyVerticallyCenteredModalf />
                                <MyVerticallyCenteredModalg />
                                <MyVerticallyCenteredModalh className='shifters'/>
                                <MyVerticallyCenteredModali className='shifters'/>
                                <MyVerticallyCenteredModalj />

                            </div>
                            <div className='row'>

                                <MyVerticallyCenteredModalk />
                                <MyVerticallyCenteredModall className='shifters'/>
                                <MyVerticallyCenteredModalm />
                                <MyVerticallyCenteredModaln  className='shifters'/>
                                <MyVerticallyCenteredModalo />

                            </div>
                            <div className='row'>

                                <MyVerticallyCenteredModalp />
